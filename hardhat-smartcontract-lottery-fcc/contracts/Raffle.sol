...
contract Raffle is VRFConsumerBaseV2Plus, AutomationCompatibleInterface {
    ...
    /*
    In Solidity, when a function is declared payable and someone calls it with some msg.value, that ether automatically gets credited to the contract’s balance — you don’t need to explicitly “transfer it to the contract.”
    */
    ...
    */
    ...
    function performUpkeep(bytes calldata /* performData */) external override {
        ...
        //     .RandomWordsRequest({
        //         keyHash: i_gasLane,
        //         subId: i_subscriptionId, // ⚠️ change type to uint256 above
        ...
        // If you set too low, your fulfillRandomWords may run out of gas → callback fails → you don’t get your random numbers.
